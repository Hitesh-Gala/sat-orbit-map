...
(function insertLogoCredit() {
  function run() {
    ...
    // One credit on every page: two lines, the second centred under the first,
    // beside the lighthouse logo (placement and type live in styles.css).
    credit.innerHTML =
      'Hitesh Gala is a Space Researcher and<br>' +
